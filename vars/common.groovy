 ...
 */
@Field perJobTimeout = [time: 180, raasOffset: 17, unit: 'MINUTES']
...
@Field docker_repo_name = 'ci-amd64-mbed-tls-ubuntu'
@Field docker_ecr = "trustedfirmware"
...
docker run -u \$(id -u):\$(id -g) --rm --entrypoint $entrypoint \
    -w /var/lib/build -v /data/shared/`echo "${env.JOB_NAME}/${env.EXECUTOR_NUMBER}"`/src:/var/lib/build \
